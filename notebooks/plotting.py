...
def plot_time_dif(results_dict, outputs, output_dict, CO2_conc1, time1, time2, month, figsize, rows, columns, ylim, diff_only=False):
    ...
    for idx, output in enumerate(outputs):
        ...
        if diff_only:
            ...
            plt.plot(x1, y1, color = 'C0', label = f'{output} at {time1 / climlab.constants.seconds_per_day} days');
            plt.plot(x2, y2, color = 'C1',label = f'{output} at {time2 / climlab.constants.seconds_per_day} days');
