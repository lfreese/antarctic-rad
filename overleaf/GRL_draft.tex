...
\end{equation}
Our Planck function is based on a centered absorption band ($\nu$) of \ce{CO_2} at 667 cm$^{-1}$, $C_0$ is set to 0.25 ppmv, $\ell$, the spectroscopic decay parameter, is 10.4 cm$^{-1}$, and C is the \ce{CO_2} concentration. 
